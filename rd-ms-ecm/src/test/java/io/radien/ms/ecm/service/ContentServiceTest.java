...
public class ContentServiceTest {
    ...
    public void init() throws NoSuchFieldException {
        ...
        Field defaultLanguageField = contentServiceAccess.getClass().getDeclaredField("defaultLanguage");
        FieldSetter.setField(contentServiceAccess, defaultLanguageField, "en");
    }
    ...
    @Test
    public void testGetByViewIdLanguageFallback() throws NameNotValidException, ContentRepositoryNotAvailableException {
        EnterpriseContent result1 = createGenericEnterpriseContent("result1", ContentType.HTML, null, null);
        when(contentRepository.getByViewIdLanguage("result1", true, "de"))
