...
/**
 * Enumerate for the linked authorization error code messages
 *
 * @author Bruno Gama
 */
public enum LinkedAuthorizationErrorCodeMessage {
    ...
    /**
     * Linked authorization error code messages constructor
     *
     * @param code of the error message
     * @param key of the error message
     * @param fallBackMessage of the error message
     */
    LinkedAuthorizationErrorCodeMessage(int code, String key, String fallBackMessage) {
        this.code = code;
        this.key=key;
