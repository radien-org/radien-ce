 ...
 */
public class TenantRoleResponseExceptionMapperTest extends TestCase {

    @Test
    public void testHandles() {
        TenantRoleResponseExceptionMapper rRexceptionMapper = new TenantRoleResponseExceptionMapper();
    ...
    public void testThrowable() {
        ...
        TenantRoleResponseExceptionMapper target = new TenantRoleResponseExceptionMapper();
