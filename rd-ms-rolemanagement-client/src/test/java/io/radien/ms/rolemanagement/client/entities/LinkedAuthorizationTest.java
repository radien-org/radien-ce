...
public class LinkedAuthorizationTest extends TestCase {
    ...
    private LinkedAuthorization linkedAuthorization;
    Date now = new Date();
    ...
    public void testConstructor() {
        LinkedAuthorization newAuthorization = new LinkedAuthorization(LinkedAuthorizationFactory.create(3L, 3L, 3L, 3L, 3L));
