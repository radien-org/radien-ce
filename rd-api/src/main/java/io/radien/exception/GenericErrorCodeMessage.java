...
public enum GenericErrorCodeMessage {
    ...
    TENANT_ROLE_ASSOCIATION_EXISTS("TR10", "error.no.association.tenant.roles", "There is no association between tenant %s and roles %s."),
    TENANT_ROLE_USER_ASSOCIATION_EXISTS("TR11", "error.no.association.tenant.roles", "There is no association between tenant %s , user % and roles %s."),
