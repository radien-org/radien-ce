...
public class ContentRepositoryNotAvailableExceptionTest {
    @Test
    public void testDefaultConstructor() {
        ContentRepositoryNotAvailableException exception = new ContentRepositoryNotAvailableException();
    ...
    public void testConstructorMessageAndExceptionAndStatus() {
        ...
        ContentRepositoryNotAvailableException exception = new ContentRepositoryNotAvailableException("errorMessage",
