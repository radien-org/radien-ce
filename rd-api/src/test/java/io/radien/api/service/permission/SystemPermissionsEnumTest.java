...
public class SystemPermissionsEnumTest {
    ...
    public void testGetPermissionNameForThirdPartyPasswordDomain() {
        ...
        assertEquals(SystemResourcesEnum.THIRD_PARTY_PASSWORD,
                SystemPermissionsEnum.THIRD_PARTY_PASSWORD_MANAGEMENT_CREATE.getResource());

        assertEquals(SystemActionsEnum.ACTION_CREATE,
                SystemPermissionsEnum.THIRD_PARTY_PASSWORD_MANAGEMENT_CREATE.getAction());
    }
