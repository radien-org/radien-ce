...
@Component({
  selector: 'app-sidenav-backdrop-essenziell',
  templateUrl: './sidenav-backdrop-essenziell.component.html',
  styleUrls: ['./sidenav-backdrop-essenziell.component.scss']
})
export class SidenavBackdropComponentEssenziell implements OnInit {
