 ...
 * @author Santana
 */
public class System${resource-name}MessageBodyReaderTest extends TestCase {

    @Test
    public void testIsReadable() {
        System${resource-name}MessageBodyReader target = new System${resource-name}MessageBodyReader();
    ...
    public void testReadFrom() throws IOException {
        ...
        System${resource-name} ${resource-name-variable} =target.readFrom(null,null,null,null,null, inputStream);
