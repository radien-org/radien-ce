 ...
 */
@Provider
public class TicketResponseExceptionMapper extends ModelResponseExceptionMapper {
     ...
     */
    public boolean ticketHandles(int statusCode, MultivaluedMap<String, Object> headers) {
     ...
     * @return a exception
     */
    public Exception ticketToThrowable(Response response) {
