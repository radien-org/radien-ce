...
/**
 * Class that aggregates UnitTest cases for TicketResponseExceptionMapper
 *
 * @author Rui Soares
 */
public class TicketResponseExceptionMapperTest {
    @InjectMocks
    private TicketResponseExceptionMapper ticketResponseExceptionMapper;
    ...
    public void testHandles() {
        ...
        boolean handlesException200 = ticketResponseExceptionMapper.ticketHandles(200, null);

        doReturn(true).when(modelResponseExceptionMapper).handles(400, null);
        boolean handlesException400 = ticketResponseExceptionMapper.ticketHandles(400, null);

        doReturn(true).when(modelResponseExceptionMapper).handles(401, null);
        boolean handlesException401 = ticketResponseExceptionMapper.ticketHandles(401, null);

        doReturn(true).when(modelResponseExceptionMapper).handles(404, null);
        boolean handlesException404 = ticketResponseExceptionMapper.ticketHandles(404, null);

        doReturn(true).when(modelResponseExceptionMapper).handles(500, null);
        boolean handlesException500 = ticketResponseExceptionMapper.ticketHandles(500, null);
    ...
    public void testToThrowable() {
        ...
        Exception exception_BadRequest = ticketResponseExceptionMapper.toThrowable(mockResponse_BadRequest);
        ...
        Exception exception_TokenExpiredException = ticketResponseExceptionMapper.ticketToThrowable(mockResponse_TokenExpiredException);
        ...
        Exception exception_NotFoundException = ticketResponseExceptionMapper.ticketToThrowable(mockResponse_NotFoundException);
        ...
        Exception exception_InternalServerException = ticketResponseExceptionMapper.ticketToThrowable(mockResponse_InternalServerException);
