...
/**
 * ${entityResourceName} mapper for the exceptions
 * @author Rajesh Gavvala
 */
@Provider
public class ${entityResourceName}ResponseExceptionMapper extends ModelResponseExceptionMapper {
     ...
     */
    public boolean ${entityResourceName.toLowerCase()}Handles(int statusCode, MultivaluedMap<String, Object> headers) {
     ...
     * @return a exception
     */
    public Exception ${entityResourceName.toLowerCase()}ToThrowable(Response response) {
