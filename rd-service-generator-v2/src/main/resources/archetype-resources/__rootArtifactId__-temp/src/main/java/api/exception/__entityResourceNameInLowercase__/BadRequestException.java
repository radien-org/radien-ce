...
/**
 * ${entityResourceName} specific Bad request exception
 * this exception is to be thrown when the ${entityResourceName.toLowerCase}
 * requests something that will have wrong requested data
 *
 * @author Nuno Santana
 */
