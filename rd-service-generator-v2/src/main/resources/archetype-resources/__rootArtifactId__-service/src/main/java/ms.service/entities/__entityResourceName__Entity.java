...
public class ${entityResourceName}Entity extends ${entityResourceName} {

	public ${entityResourceName}Entity(){ }

	public ${entityResourceName}Entity(${entityResourceName} ${entityResourceName.toLowerCase()}){
