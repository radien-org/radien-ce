...
public class SystemRoleMessageBodyReader implements MessageBodyReader<SystemRole> {
    ...
    @Override
    public SystemRole readFrom(Class<SystemRole> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, String> httpHeaders, InputStream entityStream) throws IOException, WebApplicationException {
