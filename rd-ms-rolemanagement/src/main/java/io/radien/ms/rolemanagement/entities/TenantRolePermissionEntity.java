...
public class TenantRolePermissionEntity extends io.radien.ms.rolemanagement.client.entities.TenantRolePermission {

	/**
	 * Tenant Role Permission entity empty constructor
	 */
	public TenantRolePermissionEntity(){ }
	 ...
	 * to be added/created
	 */
	public TenantRolePermissionEntity(io.radien.ms.rolemanagement.client.entities.TenantRolePermission tenantRolePermission){
