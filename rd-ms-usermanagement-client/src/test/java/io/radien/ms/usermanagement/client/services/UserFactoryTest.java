...
public class UserFactoryTest {
    ...
    public UserFactoryTest() {
        ...
        user = UserFactory.create("testFirstName", "testLastname", "logonTest", "sub",null, "emailtest@emailtest.pt", 2L);
    }
    ...
    public void create() {
        ...
        User constructedNewUser = userFactory.create("testFirstName", "testLastname", "logonTest", "sub",null, "emailtest@emailtest.pt", 2L);
