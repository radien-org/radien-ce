...
public class ActionService implements ActionServiceAccess {
    ...
    public Page<SystemAction> getAll(String search, int pageNo, int pageSize,
        ...
        return new Page<>(systemActions, pageNo, totalRecords, totalPages);
    }
     ...
     */
    @Override
    public void update(SystemAction action) throws UniquenessConstraintException {
        EntityManager em = getEntityManager();
        checkUniqueness(action, em);
        em.merge(action);
    }
     ...
     */
    @Override
    public boolean delete(Collection<Long> actionIds) {
        EntityManager em = getEntityManager();
        CriteriaBuilder cb = em.getCriteriaBuilder();
        CriteriaDelete<ActionEntity> criteriaDelete = cb.createCriteriaDelete(ActionEntity.class);
        Root<ActionEntity> actionRoot = criteriaDelete.from(ActionEntity.class);
     ...
     */
    @Override
    public List<SystemAction> getActions(SystemActionSearchFilter filter) {
        EntityManager em = getEntityManager();
        CriteriaBuilder criteriaBuilder = em.getCriteriaBuilder();
        CriteriaQuery<ActionEntity> criteriaQuery = criteriaBuilder.createQuery(ActionEntity.class);
        Root<ActionEntity> actionRoot = criteriaQuery.from(ActionEntity.class);
