...
import io.radien.ms.permissionmanagement.util.PermissionModelMapper;
 ...
 *
 */
public class PermissionModelMessageBodyWriter implements MessageBodyWriter<Permission> {
