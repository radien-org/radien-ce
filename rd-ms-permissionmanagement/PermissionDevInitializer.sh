...
curl -L -X POST 'http://localhost:8085/permissionmanagementservice/v1/permission' -H 'Authorization: Bearer '$ACCESS_TOKEN -H 'Content-Type: application/json' --data-raw '{ "name": "User Management - Create", "actionId": 1, "resourceId": 1 }'
curl -L -X POST 'http://localhost:8085/permissionmanagementservice/v1/permission' -H 'Authorization: Bearer '$ACCESS_TOKEN -H 'Content-Type: application/json' --data-raw '{ "name": "User Management - Read", "actionId": 2, "resourceId": 1 }'
curl -L -X POST 'http://localhost:8085/permissionmanagementservice/v1/permission' -H 'Authorization: Bearer '$ACCESS_TOKEN -H 'Content-Type: application/json' --data-raw '{ "name": "User Management - Update", "actionId": 3, "resourceId": 1 }'
curl -L -X POST 'http://localhost:8085/permissionmanagementservice/v1/permission' -H 'Authorization: Bearer '$ACCESS_TOKEN -H 'Content-Type: application/json' --data-raw '{ "name": "User Management - Delete", "actionId": 4, "resourceId": 1 }'
