...
import io.radien.ms.tenantmanagement.client.util.TenantRolePermissionModelMapper;
...
public class TenantRolePermissionMessageBodyReader implements MessageBodyReader<TenantRolePermission> {
	...
	@Override
	public TenantRolePermission readFrom(Class<TenantRolePermission> type, Type genericType, Annotation[] annotations, MediaType mediaType, MultivaluedMap<String, String> httpHeaders, InputStream entityStream) throws WebApplicationException {
		try {
