...
/**
 * Converts a Permission Pojo object into a Json Stream
...
public class PermissionMessageBodyWriter implements MessageBodyWriter<Permission> {
	...
	/**
	 * Calculates the size of the permission message size
	...
	/**
	 * Will call the permission mapper to convert the given object into a json
	 *
