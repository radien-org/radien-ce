...
public class KeycloakBusinessServiceTest {
    ...
    public void testCreateUser() throws Exception {
        ...
        String firstName = "a";
        UserEntity u = new UserEntity(UserFactory.create(firstName, "", "a4", "teste", "a@b.pt","951", 0L, false));
    ...
    public void testUpdateUser() throws Exception {
        doReturn(EMPTY_MOCK_RESPONSE).when(client).createUser(any());
        SystemUser u = UserFactory.create("firstname", "", "a4", "teste", "a@b.pt","951", 0L, false);
