...
//        requestBodyEntity = Mockito.mock(RequestBodyEntity.class);
//
...
//
//        //Field field = Mockito.field(KeycloakClient.class, "result");
...
//        HttpResponse<HashMap> httpResponse = Mockito.mock(HttpResponse.class);
...
//        HttpResponse<ArrayList> httpResponse = Mockito.mock(HttpResponse.class);
...
//        keycloakClient
//                .idpUrl(idpUrl)
//                .radienTokenPath(rdTokenPath)
//                .radienClientId(rdClientId)
//                .radienSecret(rdClientSecret);
