...
public class UserServiceTest extends TestCase {
     ...
     */
    @Test
    public void testDeleteByListOfIds() throws InvalidRequestException, NotFoundException {
    ...
    public void testUpdateSuccess() throws Exception {
        ...
        userService.update(u1.getId(), u3);
        ...
        userService.update(u1.getId(), u4);
    ...
    public void testUpdateFailureMultipleRecords() throws Exception {
        ...
        Exception exceptionEmailAndLogon = assertThrows(Exception.class, () -> userService.update(u1.getId(), u4));
    ...
    public void testUpdateFailureDuplicatedEmail() throws Exception {
        ...
        Exception exceptionEmail = assertThrows(Exception.class, () -> userService.update(u1.getId(), u3));
        ...
        Exception exceptionEmail2 = assertThrows(Exception.class, () -> userService.update(u1.getId(), u4));
    ...
    public void testUpdateFailureDuplicatedLogon() throws Exception {
        ...
        Exception exceptionLogon = assertThrows(Exception.class, () -> userService.update(u1.getId(), u3));
        ...
        Exception exceptionLogon2 = assertThrows(Exception.class, () -> userService.update(u1.getId(), u4));
    ...
    public void testGetAllSort() throws InvalidRequestException {
        ...
        uTest = UserFactory.create("zzz", "lastName", "b",
                "b", "b@email.pt", 2L);
        userService.save(uTest);
        Page<User> userPage = userService.getAll(null, null, null, 1, 2, Collections.singletonList("firstname"), true, true);
        assertTrue(userPage.getTotalResults()>=2);
        assertEquals("a",userPage.getResults().get(0).getFirstname());

        userPage = userService.getAll(null, null, null, 1, 2, Collections.singletonList("firstname"), false, true);
        assertTrue(userPage.getTotalResults()>=2);
        assertEquals("zzz",userPage.getResults().get(0).getFirstname());

    }

    public void testGetAllSubsOrEmailsOrLogons() throws InvalidRequestException {
        uTest = UserFactory.create("a", "lastName", "a1",
                "a1", "a1@email.pt", 2L);
        userService.save(uTest);
        uTest = UserFactory.create("zzz", "lastName", "b1",
                "b1", "b1@email.pt", 2L);
        userService.save(uTest);
        Page<User> userPage = userService.getAll(Arrays.asList("a1","b1"),
                Arrays.asList("a1@email.pt","b1@email.pt"),
                Arrays.asList("a1","b1"), 1, 2, Collections.singletonList("firstname"), true, false);
        assertEquals(2,userPage.getTotalResults());
