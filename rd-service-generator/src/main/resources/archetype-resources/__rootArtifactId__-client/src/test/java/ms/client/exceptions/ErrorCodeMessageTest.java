 ...
 */
package ${package}.ms.client.exceptions;
...
public class ErrorCodeMessageTest {
    ...
    public void testToString() {
        ...
        assertEquals("{\"code\":\"G2\", \"key\":\"error.duplicated.field\", \"message\":\"There is more than one resource with the same value for the field: Email Address\"}", ErrorCodeMessage.DUPLICATED_FIELD.toString("Email Address"));
    }
}
