...
## Create ROOT Tenant
curl -L -X POST 'http://localhost:8082/tenantmanagementservice/v1/tenant' -H 'Authorization: Bearer '$ACCESS_TOKEN -H 'Content-Type: application/json' --data-raw '{"key": "EVCorp", "name": "Root Tenant", "type": "Root", "start": "2030-01-22", "end": "2040-01-22"}'
curl -L -X POST 'http://localhost:8082/tenantmanagementservice/v1/tenant' -H 'Authorization: Bearer '$ACCESS_TOKEN -H 'Content-Type: application/json' --data-raw '{"key": "EVCorp", "name": "Client Tenant", "type": "Client", "start": "2030-01-22", "end": "2040-01-22", "clientAddress": "Sophiestrasse 33", "clientZipCode": "38118", "clientCity":"Braunschweig", "clientCountry":"Germany", "clientPhoneNumber":933876547, "clientEmail":"email@email.com", "parentId":1, "clientId":1}'
curl -L -X POST 'http://localhost:8082/tenantmanagementservice/v1/tenant' -H 'Authorization: Bearer '$ACCESS_TOKEN -H 'Content-Type: application/json' --data-raw '{"key": "EVCorp", "name": "Sub Tenant", "type": "Sub", "start": "2030-01-22", "end": "2040-01-22", "parentId":2, "clientId":2}'
