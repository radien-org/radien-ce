...
public class TenantTest {
    ...
    public void testTenantTest() {
        io.radien.ms.tenantmanagement.client.entities.Tenant t = new io.radien.ms.tenantmanagement.client.entities.Tenant(1L, "name", "tenantKey", TenantType.ROOT_TENANT, null, null, "address", "zip", "city", "country", 123L, "email", 1L, 1L);
