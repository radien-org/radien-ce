...
public class DemoModelListMessageBodyWriterTest extends TestCase {
    DemoModelListMessageBodyWriter target = new DemoModelListMessageBodyWriter();
    ...
    public void testWriteTo() throws IOException {
        ...
        Demo u = DemoFactory.create("name");
