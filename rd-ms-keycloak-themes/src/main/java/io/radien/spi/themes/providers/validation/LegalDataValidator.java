...
public class LegalDataValidator implements FormAction, FormActionFactory {

    private static final String PROVIDER_ID = "legal-data-field-validation-action";
    ...
    public static final String FIELD_ACCEPTED_TERMS = "terms_2";
    ...
    public String getDisplayType() {
        return "Legal Data Acceptance Validation";
    }
    ...
    public String getHelpText() {
        return "Asserts that user accepted the legal data before proceeding.";
    }
