...
/**
 * Class that aggregates UnitTest cases for LazyTenantDataModel
 *
 * @author Rajesh Gavvala
 */
public class LazyTenantDataModelTest {
    @InjectMocks
    private LazyTenantDataModel lazyTenantDataModel;
    ...
    List<? extends SystemTenant> systemTenants;
    ...
    public void before(){
        ...
        new LazyTenantDataModel(service);
    }
    ...
    public void testGetDataException() throws SystemException {
        lazyTenantDataModel.getData(1, 0, null, null);
    }
}