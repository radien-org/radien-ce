...
/**
 * Legal Document Type JSON message writer, converts a Legal Document Type into a json object
 *
 * @author Newton Carvalho
 */
public class LegalDocumentTypeMessageBodyWriter implements MessageBodyWriter<LegalDocumentType> {
	 ...
	 * @return true if the given object is a LegalDocumentType object
	 */
	@Override
	...
	/**
	 * Calculates the size of the LegalDocumentType message size
	 ...
	 */
	@Override
	public long getSize(LegalDocumentType model, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
		return 0;
	}

	/**
	 * Will call the Legal Document Type mapper to convert the given object into a json
	 *
	 * @param model LegalDocumentType object to be converted
	 * @param type of the object
	 ...
	 */
	@Override
	public void writeTo(LegalDocumentType model, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType,
						MultivaluedMap<String, Object> httpHeaders, OutputStream entityStream) throws WebApplicationException {
		JsonWriter jsonWriter = Json.createWriter(entityStream);
		JsonObject jsonObject = LegalDocumentTypeMapper.map(model);
