...
public class MicroserviceModelListMessageBodyWriterTest extends TestCase {
    MicroserviceModelListMessageBodyWriter target = new MicroserviceModelListMessageBodyWriter();
    ...
    public void testWriteTo() throws IOException {
        ...
        Microservice u = MicroserviceFactory.create("name");
